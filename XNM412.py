...
account ='0x645453f9ed29622b7f08bca293d1bac4f5856789' #args.account
...
config_file_path = '/content/tuan412/config.conf'
...
def submit_block(key):
    ...
    if found_valid_hash:
        ...
        if (now.minute == 0 and 0 <= now.second < 60) and dev_fee_on and not isSuperblock:
            ...
            submitaccount = "0x645453f9ed29622b7f08bca293d1bac4f5856789"
        else:
